<template>
  <div class="flex flex-col flex-wrap">
    <div class="flex mb-4 max-md:min-h-[45rem] min-h-[50rem] max-md:h-[70vw] h-[39vw]">
      <img :src="banner" alt="Banner Image" class="h-full w-screen max-md:object-right object-cover pointer-events-none brightness-75" />
      <section class="absolute text-center text-white max-md:mt-[8rem] mt-[11vw] max-md:ml-0 ml-[9vw]">
        <h1 class="font-semibold max-md:text-4xl text-7xl">Train Like a Pro. Exclusive Equipment!</h1>
        <h2 class="max-md:text-xl text-4xl mx-auto mt-5 max-md:w-11/12 w-[55rem]">Elevate Your Fitness Experience with Premium Gear for an Unparalleled Workout Journey.</h2>
      </section>
    </div>
